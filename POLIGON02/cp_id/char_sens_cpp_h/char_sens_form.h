#ifndef CHAR_SENS_FORM
#define CHAR_SENS_FORM
...
#include "char_sens_convertor.h"

// форма
class char_sens_form : public QWidget
{
    Q_OBJECT
public:
    // констуктор
    char_sens_form(QString _xml_full_dir_path, QString _xml_file_name,
    ...
    char_sens_table_data * ret_ptr_table_data();                                // вернуть данные таблицы
    char_sens_table_view * ret_ptr_table_view();                                // вернуть представление таблицы
    char_sens_convertor * ret_ptr_convertor();                                  // вернуть конвертор
    ...
    void set_ptr_table_data(char_sens_table_data * _ptr_table_data);            // установить данные таблицы
    void set_ptr_table_view(char_sens_table_view * _ptr_table_view);            // установить представление таблицы
    void set_ptr_convertor(char_sens_convertor * _ptr_convertor);               // установить конвертор
...
private:
    ...
    char_sens_table_data * ptr_table_data;     // данные таблицы
    char_sens_table_view * ptr_table_view;     // представление таблицы
    char_sens_convertor * ptr_convertor;       // конвертор
