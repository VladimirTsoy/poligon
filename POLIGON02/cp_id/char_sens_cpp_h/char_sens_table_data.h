#ifndef CHAR_SENS_TABLE_DATA
#define CHAR_SENS_TABLE_DATA
...
// данные таблицы
class char_sens_table_data
{
public:
    // конструктор
    char_sens_table_data(QString _full_file_name,
                         QString _table_tag_name,
                         QString _row_tag_name);
    // деструктор
    ~char_sens_table_data();
    ...
    char_sens_row_data * ret_first();                 // вернуть указатель на первый элемент
    char_sens_row_data * ret_last();                  // вернуть указатель на последний элемент
    ...
    void set_first(char_sens_row_data * _first);      // установить указатель на первый элемент
    void set_last(char_sens_row_data * _last);        // установить указатель на последний элемент
...
private:
    ...
    // список элементов -----------------------------------------------------------------------------------------------
    char_sens_row_data * first; // указатель на первый элемент
    char_sens_row_data * last;  // указатель на последний элемент
    // ----------------------------------------------------------------------------------------------------------------
};

#endif // CHAR_SENS_TABLE_DATA
