#ifndef SENS_SITE_TABLE_DATA
#define SENS_SITE_TABLE_DATA
...
// данные таблицы
class sens_site_table_data
{
public:
    // конструктор
    sens_site_table_data(QString _full_file_name,
                         QString _table_tag_name,
                         QString _row_tag_name);
    // деструктор
    ~sens_site_table_data();
    ...
    sens_site_row_data * ret_first();                 // вернуть указатель на первый элемент
    sens_site_row_data * ret_last();                  // вернуть указатель на последний элемент
    ...
    void set_first(sens_site_row_data * _first);      // установить указатель на первый элемент
    void set_last(sens_site_row_data * _last);        // установить указатель на последний элемент
...
private:
    ...
    // список элементов -----------------------------------------------------------------------------------------------
    sens_site_row_data * first; // указатель на первый элемент
    sens_site_row_data * last;  // указатель на последний элемент
    // ----------------------------------------------------------------------------------------------------------------
};

#endif // SENS_SITE_TABLE_DATA
