#ifndef SENS_SITE_TABLE_VIEW
#define SENS_SITE_TABLE_VIEW
...
class sens_site_table_view : public QObject
{
    Q_OBJECT
public:
    // конструктор
    sens_site_table_view(QVBoxLayout * _table_lo,
                         QPushButton * _p_b_save,
                         QPushButton * _p_b_add_row,
                         QLineEdit * _variant_l_e);

    // деструктор
    ~sens_site_table_view();
    ...
    void set_signal_slot_connection_cell_change_p_b_save_enable(sens_site_row_view * _iter);
    ...
    void insert_row_in_table(sens_site_row_view * _iter);
    ...
    sens_site_row_view * ret_first();                         // вернуть указатель на первый элемент
    sens_site_row_view * ret_last();                          // вернуть указатель на последний элемент
    ...
    void set_first(sens_site_row_view * _first);              // установить указатель на первый элемент
    void set_last(sens_site_row_view * _last);                // установить указатель на последний элемент
...
private:
    ...
    // список элементов -----------------------------------------------------------------------------------------------
    sens_site_row_view * first;   // указатель на первый элемент
    sens_site_row_view * last;    // указатель на последний элемент
    // ----------------------------------------------------------------------------------------------------------------
