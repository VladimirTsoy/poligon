...
// форма
class etalon_form : public QWidget
{
    Q_OBJECT
public:
    // констуктор
    etalon_form(QString _xml_full_dir_path, QString _xml_file_name,
    ...
    etalon_table_data * ret_ptr_table_data();                                   // вернуть данные таблицы
    etalon_table_view * ret_ptr_table_view();                                   // вернуть представление таблицы
    etalon_convertor * ret_ptr_convertor();                                     // вернуть конвертор
    ...
    void set_ptr_table_data(etalon_table_data * _ptr_table_data);               // установить данные таблицы
    void set_ptr_table_view(etalon_table_view * _ptr_table_view);               // установить представление таблицы
    void set_ptr_convertor(etalon_convertor * _ptr_convertor);                  // установить конвертор
...
private:
    ...
    etalon_table_data * ptr_table_data;        // данные таблицы
    etalon_table_view * ptr_table_view;        // представление таблицы
    etalon_convertor * ptr_convertor;          // конвертор

    QVBoxLayout * sub_table_lo;                // подтаблица
