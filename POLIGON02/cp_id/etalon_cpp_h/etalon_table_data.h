#ifndef ETALON_TABLE_DATA
#define ETALON_TABLE_DATA
...
// данные таблицы
class etalon_table_data
{
public:
    // конструктор
    etalon_table_data(QString _full_file_name,
    ...
    etalon_row_data * ret_first();                        // вернуть указатель на первый элемент
    etalon_row_data * ret_last();                         // вернуть указатель на последний элемент
    ...
    void set_first(etalon_row_data * _first);             // установить указатель на первый элемент
    void set_last(etalon_row_data * _last);               // установить указатель на последний элемент
...
private:
    ...
    // список элементов -----------------------------------------------------------------------------------------------
    etalon_row_data * first;  // указатель на первый элемент
    etalon_row_data * last;   // указатель на последний элемент
    // ----------------------------------------------------------------------------------------------------------------
};

#endif // ETALON_TABLE_DATA
